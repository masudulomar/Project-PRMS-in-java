...
function GenerateReport(){	
	var DataString="data="+document.getElementById("ReportType").value;
	DataString=DataString+"&EmployeeID="+document.getElementById("EmployeeID").value;
...
<body onload="initValues()">
	<center>
		<h2>Download Report From Here</h2>
		<div class="alert">
			<span class="closebtn"
				onclick="this.parentElement.style.display='none';">&times;</span> <strong>Under Construction!</strong>
			Will available soon!!
		</div>
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType" >
							<option value="emp_list">Employee List</option>
							<option value="emp_hist">Employee History</option>							
						</select>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" id="EmployeeID" name="EmployeeID" onkeypress="ValidateEmployeeId(event)">
					</div>
				</div>
