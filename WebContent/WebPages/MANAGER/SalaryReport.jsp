...
<body onload="initValues()">
	<center>
		<h2 style="color:#006600;">Salary Report Download Page</h2>
				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType" >
							<option value="details_rpt">Details Report</option>
							<option value="summary_rpt">Summary Report</option>
							<option value="bank_adv_rpt">Bank Advice Report</option>
							<option value="indvidual_pay_slip">Individual Payslip</option>
						</select>
					</div>
				</div>
