...
function GenerateReport(){	
	...
	if(!branchCode.includes("9999")){
		alert("Income Tax Report is currently not available for branches! will avail soon!!\n");
		return;
	}
   if(document.getElementById("financialYear").value == ""){
	...
	DataString=DataString+"&Branch_Code="+branchCode+"&empID="+emp_id+"&financialYear="+document.getElementById("financialYear").value;
		var xhttp = new XMLHttpRequest();		
...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">Income Tax Report Download Page</h2>
		...
		<form action="DownloadReportFinance.jsp">
         	<Button class="backButton" style="vertical-align:middle"><span>Salary Report</span></Button>
        </form>	
	</center>
</body>
</html>