	...
	<h2>Update Employee Information</h2>
		<div class="container">
				...
				<div class="row">
					...
					<div class="colr-20">
						<select id="Designation" name="Designation"  onkeypress="DesignationValidation(event)" style="width: 235px;">							
				...
				<div class="row">
					...
					<div class="colr-20">
						<select id="DeptCode" name="DeptCode" onkeypress="DeptCodeValidation(event)" style="width: 235px;">
						    <option value="0"> Not Applicable </option>
							<option value="1">	BOARD OF DIRECTORS</option>
							<option value="2">	MD's SECRETARIAT</option>
							<option value="3">	DMD's OFFICE</option>
							<option value="4">	GM(Administration)</option>
							<option value="5">	GM(Law & Training)</option>
							<option value="6">	GM(Recovery,ECS & PHRD)</option>
							<option value="7">	GM(Account, ICT & Marketing)</option>
							<option value="8">	GM(Audit,Saleable, & East)</option>
							<option value="25">	GM(Loan & West)</option>
				...
				<div class="row">	
					...
					<div class="col-20">
						<select id="GenderType" name="GenderType" onkeypress="GenderValidation(event)" style="width: 145px;" >
							<option value="M">M-Male</option>
							<option value="F">F-Female</option>
						</select>
					</div>	
					
					<div style="width: 15%; float: left; margin-left: 50px">
						<label for="BloodGrp">Blood Group </label>
					</div>				
					<div class="col-20">
						<select id="BloodGrp" name="BloodGrp" onkeypress="BloodGrpValidation(event)">
					...
					<div class="col-20">
						<select id="Rhfactor" name="Rhfactor" onkeypress="RhfactorValidation(event)" >
