	...
	<h2>Employee Updation</h2>
		<div class="container">
             ...
             <fieldset>
				...
				<div class="row">
					<div class="col-25">
						Is Branch Transfer? <input type="checkbox" id="branchCheck" onclick="TransferCheck(event)" onkeypress="TransferCheck(event)">
					</div>
					<div class="col-15">		
						<input id="NewBranch" type="text" name="NewBranch" maxlength="20" onkeypress="branchCodeValidation(event)" placeholder="New Branch Code">
				    </div>
				    <div class="col-35">		
						<p id="BranchName"></p>
					</div>
				...
				<div class="row">
					<div class="col-25">
						Is Basic Pay update? <input type="checkbox" id="basicCheck"
				...
				<div class="row">
					<div class="col-25">
						Is Designation update? 
						<input type="checkbox" id="DesigCheck" onclick="DesignationUpdationCheck(event)" onkeypress="DesignationUpdationCheck(event)">
					</div>
					<div class="col-75">
